...
namespace zwg_china.service
{
    ...
    /// </summary>
    [DataContract]
    public class RewardForRechargePlanDetailExport
    {
        #region 属性
        ...
        /// 实例化一个新的充值奖励的计划的明细
        /// </summary>
        /// <param name="model">充值奖励的计划的明细的数据模型</param>
        public RewardForRechargePlanDetailExport(RewardForRechargePlanDetail model)
        {
            this.Id = model.Id;
