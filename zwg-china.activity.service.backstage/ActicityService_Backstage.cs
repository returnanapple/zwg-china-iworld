...
namespace zwg_china.service
{
    ...
    /// 活动模块的数据服务
    /// </summary>:
    public class ActicityService_Backstage : ServiceBase, IActicityService_Backstage
    {
        #region 获取数据
        ...
        public PageResult<RewardForConsumptionPlanExport> GetRewardForConsumptionPlans(GetRewardForConsumptionPlansImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        public PageResult<RewardForConsumptionRecordExport> GetRewardForConsumptionRecords(GetRewardForConsumptionRecordsImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        public PageResult<RewardForRechargePlanExport> GetRewardForRechargePlans(GetRewardForRechargePlansImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        public PageResult<RedeemPlanExport> GetRedeemPlans(GetRedeemPlansImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        public PageResult<RedeemRecordExport> GetRedeemRecords(GetRedeemRecordsImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        public NormalResult CreateRewardForRegisterPlan(CreateRewardForRegisterPlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult EditRewardForRegisterPlan(EditRewardForRegisterPlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult CreateRewardForConsumptionPlan(CreateRewardForConsumptionPlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult EditRewardForConsumptionPlan(EditRewardForConsumptionPlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult CreateRewardForRechargePlan(CreateRewardForRechargePlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult EditRewardForRechargePlan(EditRewardForRechargePlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult CreateRedeemPlan(CreateRedeemPlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
        ...
        /// <param name="import">数据集</param>
        /// <returns>返回操作结果</returns>
        public NormalResult EditRedeemPlan(EditRedeemPlanImport_Backstage import)
        {
            try
            {
                import.CheckAllowExecuteOrNot(db);
