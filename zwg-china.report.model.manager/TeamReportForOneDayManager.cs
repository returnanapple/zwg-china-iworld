...
namespace zwg_china.model.manager
{
    ...
    public class TeamReportForOneDayManager : ManagerBase<IModelToDbContextOfReport, TeamReportForOneDayManager.Actions, TeamReportForOneDay>
    {
        #region 构造方法
        ...
        public TeamReportForOneDayManager(IModelToDbContextOfReport db)
            : base(db)
        {
        ...
        public static void CreateReportOnTimeline(InfoOfSendOnManagerService info)
        {
            ...
            TeamReportForOneDayManager manager = new TeamReportForOneDayManager(db);
            ...
            db.Authors.Where(x => x.Status == UserStatus.正常
                ...
                .ForEach(user =>
                {
                    ...
                    #endregion
                    TeamReportForOneDay record = new TeamReportForOneDay(user, date, money, timesOfLogin, amountOfBets, rebate
                        , bonus, commission, reward, dividend, recharge, withdrawal);
                    manager.OnExecuting(Actions.Create, record);
                    db.TeamReportForOneDays.Add(record);
