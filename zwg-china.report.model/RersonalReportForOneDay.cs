...
namespace zwg_china.model
{
    ...
    /// 单日个人统计
    /// </summary>
    public class RersonalReportForOneDay : RersonalAndTeamReportBase
    {
        #region 构造方法
        ...
        /// 实例化一个新的单日个人统计
        /// </summary>
        public RersonalReportForOneDay()
        {
        ...
        public RersonalReportForOneDay(Author owner, string date, double money, int timesOfLogin, double amountOfBets
