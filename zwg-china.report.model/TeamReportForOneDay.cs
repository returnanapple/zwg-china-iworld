...
namespace zwg_china.model
{
    ...
    /// 单日团队统计
    /// </summary>
    public class TeamReportForOneDay : RersonalAndTeamReportBase
    {
        #region 构造方法
        ...
        public TeamReportForOneDay(Author owner, string date, double money, int timesOfLogin, double amountOfBets
