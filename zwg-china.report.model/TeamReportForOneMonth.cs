...
namespace zwg_china.model
{
    ...
    /// 单月团队统计
    /// </summary>
    public class TeamReportForOneMonth : RersonalAndTeamReportBase
    {
        #region 构造方法
        ...
        public TeamReportForOneMonth(Author owner, string date, double money, int timesOfLogin, double amountOfBets
