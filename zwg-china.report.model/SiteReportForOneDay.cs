...
namespace zwg_china.model
{
    ...
    /// 单日站点统计
    /// </summary>
    public class SiteReportForOneDay : SiteReportBase
    {
        #region 构造方法
        ...
        public SiteReportForOneDay(string date, int countOfSetUp, int timesOfLogin, double amountOfBets, double rebate, double bonus
